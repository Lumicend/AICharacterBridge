...
[![日本語](https://img.shields.io/badge/Language-日本語-blue.svg)](README.md)
...
- 📖 [スタートガイド](URL)
- 📖 [ユーザーマニュアル](URL)（各種機能の詳しい説明）

---

## ドキュメント（開発者向け）

参考資料として、AI にこのプラグインの概要を説明する際に使用した[プロジェクトドキュメント](URL)を公開しています。プラグインのアーキテクチャや各モジュールの設計を詳しく説明しています。
